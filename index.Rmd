...
rass <- rass %>%
  mutate(`Acute Air Concentration` = ifelse(is.na(`Acute Air Concentration`), " ", `Acute Air Concentration`),
        ...
        `Acute Air Concentration Source` = ifelse(is.na(`Acute Air Concentration Source`), " ", `Acute Air Concentration`),
...
## Toxicity Value Descriptions
</div>

```{r acronym table, echo = F, message = F}
names <- c("Acronym", "Toxicity Source Full Name", "URL link to Toxicity Source")
hbvs <- c("HBV", "MDH Health Based Value", "https://www.health.state.mn.us/communities/environment/risk/guidance/air/table.html")
hrvs <- c("HRV", "MDH Health Risk Value", "https://www.health.state.mn.us/communities/environment/risk/guidance/air/table.html")
